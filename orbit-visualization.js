...
function updateReferenceElements() {
    ...
    lineOfNodes.rotation.y = orbitParams.raan;
    ...
    lineOfNodesLabel.position.set(6 * Math.cos(orbitParams.raan), 1, -6 * Math.sin(orbitParams.raan)); // Moved up slightly
...
function updateOrbitalPlaneLabel() {
    ...
    const x = 6.5 * Math.cos(raan); // Slightly increased radius
